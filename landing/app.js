const STR = {
  fr: {
    ...
    beta_lead: "Le test Google Play est sur invitation. Inscrivez l’adresse de votre compte Google ; ouvrez le lien du test une fois votre accès confirmé.",
    beta_join: 'Rejoindre le test bêta',
    signup_email: 'Email',
    signup_send: "Demander l’accès",
    signup_beta: 'M’inviter au test Play et m’envoyer le lien',
    signup_news: 'Newsletter Verimots (sorties, défi)',
    signup_note: 'Email seulement pour l’invitation et/ou la newsletter. Pas de pub.',
    signup_need_email: 'Indique un email valide.',
    signup_need_choice: 'Coche le test Play et/ou la newsletter.',
    signup_ok_beta: "Demande reçue. Le lien Play fonctionnera une fois votre adresse ajoutée au test.",
    signup_ok_news: 'C’est noté. Tu es sur la newsletter.',
    signup_ok_both: "Demande reçue et inscription à la newsletter enregistrée. Le lien Play fonctionnera une fois votre accès confirmé.",
    signup_optin: 'Ouvrir le lien d’opt-in Play',
    ...
    faq4a: 'Laisse ton email ci-dessus, puis ouvre le lien d’opt-in Play (test fermé). L’app n’est pas encore dans la recherche du magasin. Tu peux aussi jouer tout de suite dans le navigateur.',
    ...
    beta_info_p2: "Inscrivez l’adresse de votre compte Google. Après confirmation de l’accès, ouvrez le lien Play avec ce même compte.",
  ...
  en: {
    ...
    beta_lead: "The Google Play test is by invitation. Enter your Google account email; open the test link once your access is confirmed.",
    beta_join: 'Join the beta test',
    signup_email: 'Email',
    signup_send: "Request access",
    signup_beta: 'Invite me to the Play test and send me the link',
    signup_news: 'Verimots newsletter (releases, challenge)',
    signup_note: 'Email only for the invite and/or the newsletter. No ads.',
    signup_need_email: 'Enter a valid email.',
    signup_need_choice: 'Tick the Play test and/or the newsletter.',
    signup_ok_beta: "Request received. The Play link will work once your email has been added to the test.",
    signup_ok_news: 'Noted. You are on the newsletter.',
    signup_ok_both: "Request received and newsletter subscription saved. The Play link will work once your access is confirmed.",
    signup_optin: 'Open the Play opt-in link',
    ...
    faq4a: 'Leave your email above, then open the Play opt-in link (closed test). The app is not in store search yet. You can also play in the browser right now.',
    ...
    beta_info_p2: "Enter your Google account email. Once access is confirmed, open the Play test link with that account.",
  ...
  es: {
    ...
    beta_lead: "La prueba de Google Play requiere invitación. Indica el correo de tu cuenta Google y abre el enlace cuando se confirme tu acceso.",
    beta_join: 'Unirse a la beta',
    signup_email: 'Email',
    signup_send: "Solicitar acceso",
    signup_beta: 'Invitarme a la prueba de Play y enviarme el enlace',
    signup_news: 'Boletín de Verimots (novedades, reto)',
    signup_note: 'Email solo para la invitación y/o el boletín. Sin publicidad.',
    signup_need_email: 'Indica un email válido.',
    signup_need_choice: 'Marca la prueba de Play y/o el boletín.',
    signup_ok_beta: "Solicitud recibida. El enlace Play funcionará cuando se añada tu correo a la prueba.",
    signup_ok_news: 'Anotado. Estás en el boletín.',
    signup_ok_both: "Solicitud recibida y suscripción guardada. El enlace Play funcionará cuando se confirme tu acceso.",
    signup_optin: 'Abrir el enlace de acceso de Play',
    ...
    faq4a: 'Deja tu email arriba y abre el enlace de acceso de Play (prueba cerrada). La app aún no sale en la búsqueda de la tienda. También puedes jugar ya en el navegador.',
    ...
    beta_info_p2: "Indica el correo de tu cuenta Google. Tras confirmar tu acceso, abre el enlace Play con esa cuenta.",
  ...
  ca: {
    ...
    beta_lead: "La prova de Google Play requereix invitació. Indica el correu del teu compte Google i obre l’enllaç quan es confirmi l’accés.",
    beta_join: 'Uneix-te a la beta',
    signup_email: 'Correu',
    signup_send: "Demana accés",
    signup_beta: 'Convida’m a la prova de Play i envia’m l’enllaç',
    signup_news: 'Butlletí de Verimots (novetats, repte)',
    signup_note: 'El correu només serveix per a la invitació i/o el butlletí. Sense publicitat.',
    signup_need_email: 'Indica un correu vàlid.',
    signup_need_choice: 'Marca la prova de Play i/o el butlletí.',
    signup_ok_beta: "Sol·licitud rebuda. L’enllaç Play funcionarà quan s’afegeixi el teu correu a la prova.",
    signup_ok_news: 'Anotat. Ets al butlletí.',
    signup_ok_both: "Sol·licitud rebuda i subscripció desada. L’enllaç Play funcionarà quan es confirmi l’accés.",
    signup_optin: 'Obre l’enllaç d’accés de Play',
    ...
    faq4a: 'Deixa el teu correu a dalt i obre l’enllaç d’accés de Play (prova tancada). L’app encara no surt a la cerca de la botiga. També pots jugar ja al navegador.',
    ...
    beta_info_p2: "Indica el correu del teu compte Google. Quan es confirmi l’accés, obre l’enllaç Play amb aquest compte.",
