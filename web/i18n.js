const STR = {
  fr: {
    title: 'Verimots — Vérificateur de mots',
    ...
    about_p1: 'La liste choisie (formes de 2 à 15 lettres) sert à vérifier un mot, le tiroir et le défi.',
    about_p2: 'Les définitions viennent du Wiktionnaire et demandent une connexion, comme le partage.',
    ...
    study_blurb: 'Les mots de 2 et 3 lettres du jour — repérez-les dans vos tirages.',
    dict_stats: (n, d) => (d ? `${n} mots · en vigueur depuis le ${d}` : `${n} mots`),
  },
  en: {
    title: 'Verimots — Word checker',
    skip: 'Skip to input',
    ...
    about_p1: 'The selected list (forms of 2 to 15 letters) checks a word, powers the rack search and the challenge.',
    about_p2: 'Definitions come from Wiktionary; sharing and the board need a connection too.',
    ...
    study_blurb: 'Today’s 2- and 3-letter words — spot them on your rack.',
    dict_stats: (n, d) => (d ? `${n} words · in force since ${d}` : `${n} words`),
  },
  es: {
    title: 'Verimots — Verificador de palabras',
    ...
    about_p1: 'La lista elegida (formas de 2 a 15 letras) sirve para comprobar una palabra, el atril y el reto.',
    about_p2: 'Las definiciones vienen de Wikcionario; compartir y la clasificación también necesitan conexión.',
    ...
    menu_comp: 'Competición',
    menu_training: 'Entrenamiento',
    menu_find: 'Encuentra una palabra',
    menu_study: 'Estudio del día',
    menu_back: 'Volver',
    level_title: 'Nivel',
    level_beginner: 'Principiante',
    level_confirmed: 'Confirmado',
    study_blurb: 'Las palabras de 2 y 3 letras del día — localízalas en tus atriles.',
