const STR = {
  fr: {
    ...
    training_rules_title: 'Combinaison — les règles',
    ...
    training_rules_unranked: 'Le mode Combinaison n’est pas classé : tes statistiques restent sur cet appareil.',
